class Settings:
    ...
    def __init__(self):
        ...
        self.initialize_dynamic_settings() # Initializes values for attributes that need to change throughout the game.
    ...
    def increase_speed(self):
        ...
        self.alien_points = int(self.alien_points * self.score_scale) # So when game speed increases, point value also increases.
